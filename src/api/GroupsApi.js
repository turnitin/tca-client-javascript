...
export default class GroupsApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GetGroupAttachments200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/GetGroupAttachments200Response}
     */
    getGroupAttachments(xTurnitinIntegrationName, xTurnitinIntegrationVersion, groupId, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetGroupAttachments200Response;
      return this.apiClient.callApi(
