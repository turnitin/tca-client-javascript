...
export default class SimilarityApi {
    ...
    */
     ...
     * @param {String} xTurnitinIntegrationVersion the version of the integration platform being used
     * @param {String} id The Submission ID (returned upon a successful POST to /submissions) 
     * @param {module:model/GenerateSimilarityPDF} generateSimilarityPDF 
     ...
     */
    requestSimilarityReportPdf(xTurnitinIntegrationName, xTurnitinIntegrationVersion, id, generateSimilarityPDF, callback) {
      let postBody = generateSimilarityPDF;
      // verify the required parameter 'xTurnitinIntegrationName' is set
      if (xTurnitinIntegrationName === undefined || xTurnitinIntegrationName === null) {
      ...
      if (generateSimilarityPDF === undefined || generateSimilarityPDF === null) {
        throw new Error("Missing the required parameter 'generateSimilarityPDF' when calling requestSimilarityReportPdf");
      }
