...
import AnnotationsSettings from './model/AnnotationsSettings';
...
import GenerateSimilarityPDF from './model/GenerateSimilarityPDF';
import GetGroupAttachments200Response from './model/GetGroupAttachments200Response';
...
import PDFStatusWebhookRequest from './model/PDFStatusWebhookRequest';
...
import SimilarityCompleteWebhookRequest from './model/SimilarityCompleteWebhookRequest';
...
import SubmissionCompleteWebhookRequest from './model/SubmissionCompleteWebhookRequest';
import SubmissionCompleteWebhookRequestAllOf from './model/SubmissionCompleteWebhookRequestAllOf';
import SubmissionCompleteWebhookRequestAllOfMetadata from './model/SubmissionCompleteWebhookRequestAllOfMetadata';
...
/**
* Turnitin Core API (TCA) provides direct API access to the core functionality provided by Turnitin. TCA supports file submission, similarity report generation, group management, and visualization of report matches via Cloud Viewer or PDF download. Below is the full flow to successfully set up an integration scope, an API Key, and make calls to TCA. Integration Scope and API Key management is done via the Admin Console UI by logging in as an admin user. For more details, go to our [developer portal documentation page](https://developers.turnitin.com/docs). ## Integration Scope and API Key Management TCA API calls must provide an API Key for authentication, so you must first have at least one integration scope associated with at least one API Key to use TCA. ### Admin Console UI First, login to Admin Console UI as an *Admin* user with permission to create Integration Scopes, under a tenant that is licensed to use the TCA product Integration Scopes (you can create a new one, or add keys to existing)    * Click &#x60;Integrations&#x60; in the side bar --&gt; &#x60;+ Add Integration&#x60; at top the top of the page --&gt; Enter a name --&gt; &#x60;Add&#x60; Button   API Keys   * Click &#x60;Integrations&#x60; in the side bar --&gt; &#x60;Create API Key&#x60; Button next to a given Integration Scope --&gt;   Enter a name --&gt; click &#x60;Create and View button&#x60;   * Copy/Save the key manually or click save to clipboard button to copy it (this is the only time it will show)  ## TCA Flow    *  Register a webhook   *  Create a submission   *  Upload a file for the submission   *  Wait for the submission upload to process      * If you registered a webhook, a callback will be sent to it when upload is complete      * The status of the *submission* will also update to &#x60;COMPLETE&#x60;   *  Request a Similarity Report   *  Wait for similarity report to process      * If you registered a webhook, a callback will be sent to it when report is complete      * The status of the *report* will also be updated to &#x60;COMPLETE&#x60;   *  Request a URL with parameters to view the Similarity Report .<br>
...
export {
    ...
    /**
     * The AnnotationsSettings model constructor.
     * @property {module:model/AnnotationsSettings}
     */
    AnnotationsSettings,
    ...
    /**
     * The GenerateSimilarityPDF model constructor.
     * @property {module:model/GenerateSimilarityPDF}
     */
    GenerateSimilarityPDF,

    /**
     * The GetGroupAttachments200Response model constructor.
     * @property {module:model/GetGroupAttachments200Response}
     */
    ...
    /**
     * The PDFStatusWebhookRequest model constructor.
     * @property {module:model/PDFStatusWebhookRequest}
     */
    ...
    /**
     * The SimilarityCompleteWebhookRequest model constructor.
     * @property {module:model/SimilarityCompleteWebhookRequest}
     */
    ...
    /**
     * The SubmissionCompleteWebhookRequest model constructor.
     * @property {module:model/SubmissionCompleteWebhookRequest}
     */
    SubmissionCompleteWebhookRequest,

    /**
     * The SubmissionCompleteWebhookRequestAllOf model constructor.
     * @property {module:model/SubmissionCompleteWebhookRequestAllOf}
     */
    SubmissionCompleteWebhookRequestAllOf,

    /**
     * The SubmissionCompleteWebhookRequestAllOfMetadata model constructor.
     * @property {module:model/SubmissionCompleteWebhookRequestAllOfMetadata}
     */
