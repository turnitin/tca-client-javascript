...
class FeaturesSimilarity {
    ...
    /**
     * Validates the JSON data with respect to <code>FeaturesSimilarity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeaturesSimilarity</code>.
     */
    static validateJSON(data) {
        // validate the optional field `viewer_modes`
        if (data['viewer_modes']) { // data not null
          FeaturesViewerModes.validateJSON(data['viewer_modes']);
        }
        // validate the optional field `generation_settings`
        if (data['generation_settings']) { // data not null
          FeaturesGenerationSettings.validateJSON(data['generation_settings']);
        }
        // validate the optional field `view_settings`
        if (data['view_settings']) { // data not null
          FeaturesSimilarityViewSettings.validateJSON(data['view_settings']);
        }
