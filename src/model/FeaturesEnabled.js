...
class FeaturesEnabled {
    ...
    /**
     * Validates the JSON data with respect to <code>FeaturesEnabled</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FeaturesEnabled</code>.
     */
    static validateJSON(data) {
        // validate the optional field `similarity`
        if (data['similarity']) { // data not null
          FeaturesSimilarity.validateJSON(data['similarity']);
        }
        // validate the optional field `tenant`
        if (data['tenant']) { // data not null
          FeaturesTenant.validateJSON(data['tenant']);
        }
        ...
        if (!Array.isArray(data['access_options'])) {
            throw new Error("Expected the field `access_options` to be an array in the JSON data but got " + data['access_options']);
        }
