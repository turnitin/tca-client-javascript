...
class SimilarityMetadataAllOfTopMatches {
    ...
    /**
     * Validates the JSON data with respect to <code>SimilarityMetadataAllOfTopMatches</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimilarityMetadataAllOfTopMatches</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['submitted_date'] && !(typeof data['submitted_date'] === 'string' || data['submitted_date'] instanceof String)) {
            throw new Error("Expected the field `submitted_date` to be a primitive type in the JSON string but got " + data['submitted_date']);
        }
        // ensure the json data is a string
