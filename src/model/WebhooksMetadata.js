...
/**
 * The WebhooksMetadata model module.
 * @module model/WebhooksMetadata
 * @version 1.0.223
 */
class WebhooksMetadata {
    /**
     * Constructs a new <code>WebhooksMetadata</code>.
     * @alias module:model/WebhooksMetadata
     */
    constructor() { 
        
        WebhooksMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WebhooksMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WebhooksMetadata} obj Optional instance to populate.
     * @return {module:model/WebhooksMetadata} The populated <code>WebhooksMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebhooksMetadata();
 ...
 */
WebhooksMetadata.prototype['custom'] = undefined;
...
export default WebhooksMetadata;
