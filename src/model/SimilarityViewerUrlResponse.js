...
class SimilarityViewerUrlResponse {
    ...
    /**
     * Validates the JSON data with respect to <code>SimilarityViewerUrlResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimilarityViewerUrlResponse</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['viewer_url'] && !(typeof data['viewer_url'] === 'string' || data['viewer_url'] instanceof String)) {
            throw new Error("Expected the field `viewer_url` to be a primitive type in the JSON string but got " + data['viewer_url']);
        }
