...
class SimilarityViewerUrlSettings {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('annotations')) {
                obj['annotations'] = AnnotationsSettings.constructFromObject(data['annotations']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SimilarityViewerUrlSettings</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimilarityViewerUrlSettings</code>.
     */
    static validateJSON(data) {
        // validate the optional field `author_metadata_override`
        if (data['author_metadata_override']) { // data not null
          AuthorMetadataOverride.validateJSON(data['author_metadata_override']);
        }
        ...
        // ensure the json data is a string
        if (data['viewer_default_permission_set'] && !(typeof data['viewer_default_permission_set'] === 'string' || data['viewer_default_permission_set'] instanceof String)) {
            throw new Error("Expected the field `viewer_default_permission_set` to be a primitive type in the JSON string but got " + data['viewer_default_permission_set']);
        }
        // validate the optional field `viewer_permissions`
        if (data['viewer_permissions']) { // data not null
          ViewerPermissions.validateJSON(data['viewer_permissions']);
        }
        ...
        if (data['similarity']) { // data not null
          SimilaritySettings.validateJSON(data['similarity']);
        }
        // validate the optional field `annotations`
        if (data['annotations']) { // data not null
          AnnotationsSettings.validateJSON(data['annotations']);
        }
...
/**
 * @member {module:model/AnnotationsSettings} annotations
 */
SimilarityViewerUrlSettings.prototype['annotations'] = undefined;
