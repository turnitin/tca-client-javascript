...
class SimilarityMetadata {
    ...
    /**
     * Validates the JSON data with respect to <code>SimilarityMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SimilarityMetadata</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SimilarityMetadata.RequiredProperties) {
            if (!data[property]) {
...
SimilarityMetadata.RequiredProperties = ["overall_match_percentage", "submission_id", "status", "time_generated", "time_requested", "top_matches", "top_source_largest_matched_word_count"];
