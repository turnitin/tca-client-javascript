...
class Webhook {
     ...
     * @param id {String} unique id of webhook
     * @param url {String} the URL to callback with events, this must be https unless (allow_insecure is true)
     * @param eventTypes {Array.<module:model/Webhook.EventTypesEnum>} an array of the types of callbacks that will be sent to this webhook
     */
    constructor(id, url, eventTypes) { 
        WebhookAllOf.initialize(this, id);WebhookBase.initialize(this, url, eventTypes);
        Webhook.initialize(this, id, url, eventTypes);
    }
     ...
     */
    static initialize(obj, id, url, eventTypes) { 
        obj['id'] = id;
        obj['url'] = url;
...
Webhook.RequiredProperties = ["id", "url", "event_types"];
 ...
 */
Webhook.prototype['created_time'] = undefined;
 ...
 */
Webhook.prototype['allow_insecure'] = undefined;

/**
 * an array of the types of callbacks that will be sent to this webhook
 * @member {Array.<module:model/Webhook.EventTypesEnum>} event_types
 */
Webhook.prototype['event_types'] = undefined;
 ...
 * @member {String} id
 */
WebhookAllOf.prototype['id'] = undefined;
/**
 * RFC3339  timestamp of when this Webhook was initially created. This is the time at which the POST to /webhooks was made. 
 * @member {Date} created_time
 */
WebhookAllOf.prototype['created_time'] = undefined;
