...
import WebhooksMetadata from './WebhooksMetadata';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = WebhooksMetadata.constructFromObject(data['metadata']);
            }
        }
        return obj;
    }
 ...
 */
InlineObject.prototype['submission_id'] = undefined;

/**
 * @member {module:model/WebhooksMetadata} metadata
 */
