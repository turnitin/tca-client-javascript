...
/**
 * The SubmissionCompleteWebhookRequest model module.
 * @module model/SubmissionCompleteWebhookRequest
 * @version 1.0.258
 */
class SubmissionCompleteWebhookRequest {
    /**
     * Constructs a new <code>SubmissionCompleteWebhookRequest</code>.
     * @alias module:model/SubmissionCompleteWebhookRequest
     * @implements module:model/Submission
     * @implements module:model/SubmissionCompleteWebhookRequestAllOf
     */
    constructor() { 
        Submission.initialize(this);SubmissionCompleteWebhookRequestAllOf.initialize(this);
        SubmissionCompleteWebhookRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SubmissionCompleteWebhookRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SubmissionCompleteWebhookRequest} obj Optional instance to populate.
     * @return {module:model/SubmissionCompleteWebhookRequest} The populated <code>SubmissionCompleteWebhookRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SubmissionCompleteWebhookRequest();
            Submission.constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>SubmissionCompleteWebhookRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SubmissionCompleteWebhookRequest</code>.
     */
 ...
 * @member {String} owner
 */
SubmissionCompleteWebhookRequest.prototype['owner'] = undefined;

/**
 * the title of the submission
 * @member {String} title
 */
SubmissionCompleteWebhookRequest.prototype['title'] = undefined;

/**
 * the current status of the Submission
 * @member {module:model/SubmissionCompleteWebhookRequest.StatusEnum} status
 */
SubmissionCompleteWebhookRequest.prototype['status'] = undefined;

/**
 * the unique ID of the submission
 * @member {String} id
 */
SubmissionCompleteWebhookRequest.prototype['id'] = undefined;

/**
 * the content type of the submission
 * @member {String} content_type
 */
SubmissionCompleteWebhookRequest.prototype['content_type'] = undefined;

/**
 * the number of pages in the submission
 * @member {Number} page_count
 */
SubmissionCompleteWebhookRequest.prototype['page_count'] = undefined;

/**
 * the number of words in the submission
 * @member {Number} word_count
 */
SubmissionCompleteWebhookRequest.prototype['word_count'] = undefined;

/**
 * the number of characters in the submission
 * @member {Number} character_count
 */
SubmissionCompleteWebhookRequest.prototype['character_count'] = undefined;

/**
 * an error code representing the type of error encountered (if applicable) 
 * @member {module:model/SubmissionCompleteWebhookRequest.ErrorCodeEnum} error_code
 */
SubmissionCompleteWebhookRequest.prototype['error_code'] = undefined;
 ...
 */
SubmissionCompleteWebhookRequest.prototype['created_time'] = undefined;

/**
 * Set of capabilities available to the current submission
 * @member {Array.<module:model/SubmissionCompleteWebhookRequest.CapabilitiesEnum>} capabilities
 */
SubmissionCompleteWebhookRequest.prototype['capabilities'] = undefined;

/**
 * @member {module:model/SubmissionCompleteWebhookRequestAllOfMetadata} metadata
 */
SubmissionCompleteWebhookRequest.prototype['metadata'] = undefined;
 ...
 * @readonly
 */
SubmissionCompleteWebhookRequest['StatusEnum'] = {
 ...
 * @readonly
 */
SubmissionCompleteWebhookRequest['ErrorCodeEnum'] = {
 ...
 * @readonly
 */
SubmissionCompleteWebhookRequest['CapabilitiesEnum'] = {
...
export default SubmissionCompleteWebhookRequest;
