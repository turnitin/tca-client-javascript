...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.AddGroupAttachmentRequest();
  });
  ...
  describe('AddGroupAttachmentRequest', function() {
    it('should create an instance of AddGroupAttachmentRequest', function() {
      // uncomment below and update the code to test AddGroupAttachmentRequest
      //var instane = new TurnitinCoreApi.AddGroupAttachmentRequest();
      //expect(instance).to.be.a(TurnitinCoreApi.AddGroupAttachmentRequest);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new TurnitinCoreApi.AddGroupAttachmentRequest();
