...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityOverviewMatchGroup();
  });
  ...
  describe('SimilarityOverviewMatchGroup', function() {
    it('should create an instance of SimilarityOverviewMatchGroup', function() {
      // uncomment below and update the code to test SimilarityOverviewMatchGroup
      //var instane = new TurnitinCoreApi.SimilarityOverviewMatchGroup();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityOverviewMatchGroup);
    });

    it('should have the property glimpseId (base name: "glimpse_id")', function() {
      // uncomment below and update the code to test the property glimpseId
      //var instance = new TurnitinCoreApi.SimilarityOverviewMatchGroup();
      //expect(instance).to.be();
    });

    it('should have the property matchSegments (base name: "match_segments")', function() {
      // uncomment below and update the code to test the property matchSegments
      //var instance = new TurnitinCoreApi.SimilarityOverviewMatchGroup();
      //expect(instance).to.be();
    });
