...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.EulaAcceptRequest();
  });
  ...
  describe('EulaAcceptRequest', function() {
    it('should create an instance of EulaAcceptRequest', function() {
      // uncomment below and update the code to test EulaAcceptRequest
      //var instane = new TurnitinCoreApi.EulaAcceptRequest();
      //expect(instance).to.be.a(TurnitinCoreApi.EulaAcceptRequest);
    });

    it('should have the property userId (base name: "user_id")', function() {
      // uncomment below and update the code to test the property userId
      //var instance = new TurnitinCoreApi.EulaAcceptRequest();
