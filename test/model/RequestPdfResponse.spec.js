...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.RequestPdfResponse();
  });
  ...
  describe('RequestPdfResponse', function() {
    it('should create an instance of RequestPdfResponse', function() {
      // uncomment below and update the code to test RequestPdfResponse
      //var instane = new TurnitinCoreApi.RequestPdfResponse();
      //expect(instance).to.be.a(TurnitinCoreApi.RequestPdfResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.RequestPdfResponse();
