...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilaritySettingsModes();
  });
  ...
  describe('SimilaritySettingsModes', function() {
    it('should create an instance of SimilaritySettingsModes', function() {
      // uncomment below and update the code to test SimilaritySettingsModes
      //var instane = new TurnitinCoreApi.SimilaritySettingsModes();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilaritySettingsModes);
    });

    it('should have the property matchOverview (base name: "match_overview")', function() {
      // uncomment below and update the code to test the property matchOverview
      //var instance = new TurnitinCoreApi.SimilaritySettingsModes();
      //expect(instance).to.be();
    });

    it('should have the property allSources (base name: "all_sources")', function() {
      // uncomment below and update the code to test the property allSources
      //var instance = new TurnitinCoreApi.SimilaritySettingsModes();
      //expect(instance).to.be();
    });
