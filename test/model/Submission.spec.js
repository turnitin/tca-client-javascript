...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.Submission();
  });
  ...
  describe('Submission', function() {
    it('should create an instance of Submission', function() {
      ...
      //var instane = new TurnitinCoreApi.Submission();
      //expect(instance).to.be.a(TurnitinCoreApi.Submission);
    });

    it('should have the property owner (base name: "owner")', function() {
      // uncomment below and update the code to test the property owner
      //var instance = new TurnitinCoreApi.Submission();
