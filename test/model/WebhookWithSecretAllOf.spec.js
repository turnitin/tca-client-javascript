...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.WebhookWithSecretAllOf();
  });
  ...
  describe('WebhookWithSecretAllOf', function() {
    it('should create an instance of WebhookWithSecretAllOf', function() {
      // uncomment below and update the code to test WebhookWithSecretAllOf
      //var instane = new TurnitinCoreApi.WebhookWithSecretAllOf();
      //expect(instance).to.be.a(TurnitinCoreApi.WebhookWithSecretAllOf);
    });
    ...
    it('should have the property signingSecret (base name: "signing_secret")', function() {
      ...
      //var instance = new TurnitinCoreApi.WebhookWithSecretAllOf();
