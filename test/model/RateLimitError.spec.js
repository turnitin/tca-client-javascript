...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.RateLimitError();
  });
  ...
  describe('RateLimitError', function() {
    it('should create an instance of RateLimitError', function() {
      // uncomment below and update the code to test RateLimitError
      //var instane = new TurnitinCoreApi.RateLimitError();
      //expect(instance).to.be.a(TurnitinCoreApi.RateLimitError);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TurnitinCoreApi.RateLimitError();
