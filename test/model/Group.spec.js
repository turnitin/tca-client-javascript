...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.Group();
  });
  ...
  describe('Group', function() {
    it('should create an instance of Group', function() {
      ...
      //var instane = new TurnitinCoreApi.Group();
      //expect(instance).to.be.a(TurnitinCoreApi.Group);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.Group();
