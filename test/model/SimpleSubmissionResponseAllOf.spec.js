...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimpleSubmissionResponseAllOf();
  });
  ...
  describe('SimpleSubmissionResponseAllOf', function() {
    it('should create an instance of SimpleSubmissionResponseAllOf', function() {
      // uncomment below and update the code to test SimpleSubmissionResponseAllOf
      //var instane = new TurnitinCoreApi.SimpleSubmissionResponseAllOf();
      //expect(instance).to.be.a(TurnitinCoreApi.SimpleSubmissionResponseAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.SimpleSubmissionResponseAllOf();
