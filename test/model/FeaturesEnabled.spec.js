...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.FeaturesEnabled();
  });
  ...
  describe('FeaturesEnabled', function() {
    it('should create an instance of FeaturesEnabled', function() {
      // uncomment below and update the code to test FeaturesEnabled
      //var instane = new TurnitinCoreApi.FeaturesEnabled();
      //expect(instance).to.be.a(TurnitinCoreApi.FeaturesEnabled);
    });
    ...
    it('should have the property similarity (base name: "similarity")', function() {
      ...
      //var instance = new TurnitinCoreApi.FeaturesEnabled();
    ...
    it('should have the property accessOptions (base name: "access_options")', function() {
      // uncomment below and update the code to test the property accessOptions
      //var instance = new TurnitinCoreApi.FeaturesEnabled();
      //expect(instance).to.be();
    });
