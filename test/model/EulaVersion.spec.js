...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.EulaVersion();
  });
  ...
  describe('EulaVersion', function() {
    it('should create an instance of EulaVersion', function() {
      // uncomment below and update the code to test EulaVersion
      //var instane = new TurnitinCoreApi.EulaVersion();
      //expect(instance).to.be.a(TurnitinCoreApi.EulaVersion);
    });

    it('should have the property version (base name: "version")', function() {
      // uncomment below and update the code to test the property version
      //var instance = new TurnitinCoreApi.EulaVersion();
