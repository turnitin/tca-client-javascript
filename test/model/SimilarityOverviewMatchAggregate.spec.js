...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityOverviewMatchAggregate();
  });
  ...
  describe('SimilarityOverviewMatchAggregate', function() {
    it('should create an instance of SimilarityOverviewMatchAggregate', function() {
      // uncomment below and update the code to test SimilarityOverviewMatchAggregate
      //var instane = new TurnitinCoreApi.SimilarityOverviewMatchAggregate();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityOverviewMatchAggregate);
    });
    ...
    it('should have the property sourceType (base name: "source_type")', function() {
      ...
      //var instance = new TurnitinCoreApi.SimilarityOverviewMatchAggregate();
    ...
    it('should have the property aggregateId (base name: "aggregate_id")', function() {
      // uncomment below and update the code to test the property aggregateId
      //var instance = new TurnitinCoreApi.SimilarityOverviewMatchAggregate();
      //expect(instance).to.be();
    });

    it('should have the property matchSources (base name: "match_sources")', function() {
