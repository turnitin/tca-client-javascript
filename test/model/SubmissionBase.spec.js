...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SubmissionBase();
  });
  ...
  describe('SubmissionBase', function() {
    it('should create an instance of SubmissionBase', function() {
      // uncomment below and update the code to test SubmissionBase
      //var instane = new TurnitinCoreApi.SubmissionBase();
      //expect(instance).to.be.a(TurnitinCoreApi.SubmissionBase);
    });

    it('should have the property owner (base name: "owner")', function() {
      // uncomment below and update the code to test the property owner
      //var instance = new TurnitinCoreApi.SubmissionBase();
      //expect(instance).to.be();
    });

    it('should have the property ownerDefaultPermissionSet (base name: "owner_default_permission_set")', function() {
      // uncomment below and update the code to test the property ownerDefaultPermissionSet
      //var instance = new TurnitinCoreApi.SubmissionBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property submitterDefaultPermissionSet (base name: "submitter_default_permission_set")', function() {
      // uncomment below and update the code to test the property submitterDefaultPermissionSet
      //var instance = new TurnitinCoreApi.SubmissionBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property extractTextOnly (base name: "extract_text_only")', function() {
      // uncomment below and update the code to test the property extractTextOnly
      //var instance = new TurnitinCoreApi.SubmissionBase();
      //expect(instance).to.be();
    });
