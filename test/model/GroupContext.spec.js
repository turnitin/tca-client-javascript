...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.GroupContext();
  });
  ...
  describe('GroupContext', function() {
    it('should create an instance of GroupContext', function() {
      // uncomment below and update the code to test GroupContext
      //var instane = new TurnitinCoreApi.GroupContext();
      //expect(instance).to.be.a(TurnitinCoreApi.GroupContext);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.GroupContext();
