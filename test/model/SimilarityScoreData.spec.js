...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityScoreData();
  });
  ...
  describe('SimilarityScoreData', function() {
    it('should create an instance of SimilarityScoreData', function() {
      // uncomment below and update the code to test SimilarityScoreData
      //var instane = new TurnitinCoreApi.SimilarityScoreData();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityScoreData);
    });
    ...
    it('should have the property overallMatchPercentage (base name: "overall_match_percentage")', function() {
      ...
      //var instance = new TurnitinCoreApi.SimilarityScoreData();
