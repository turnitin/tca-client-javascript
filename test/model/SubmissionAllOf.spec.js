...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SubmissionAllOf();
  });
  ...
  describe('SubmissionAllOf', function() {
    it('should create an instance of SubmissionAllOf', function() {
      // uncomment below and update the code to test SubmissionAllOf
      //var instane = new TurnitinCoreApi.SubmissionAllOf();
      //expect(instance).to.be.a(TurnitinCoreApi.SubmissionAllOf);
    });

    it('should have the property owner (base name: "owner")', function() {
      // uncomment below and update the code to test the property owner
      //var instance = new TurnitinCoreApi.SubmissionAllOf();
