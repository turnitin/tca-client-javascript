...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityMetadataAllOfTopMatches();
  });
  ...
  describe('SimilarityMetadataAllOfTopMatches', function() {
    it('should create an instance of SimilarityMetadataAllOfTopMatches', function() {
      // uncomment below and update the code to test SimilarityMetadataAllOfTopMatches
      //var instane = new TurnitinCoreApi.SimilarityMetadataAllOfTopMatches();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityMetadataAllOfTopMatches);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new TurnitinCoreApi.SimilarityMetadataAllOfTopMatches();
    ...
    it('should have the property matchedWordCountTotal (base name: "matched_word_count_total")', function() {
      // uncomment below and update the code to test the property matchedWordCountTotal
      //var instance = new TurnitinCoreApi.SimilarityMetadataAllOfTopMatches();
      //expect(instance).to.be();
    });
