...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.WebhookWithSecret();
  });
  ...
  describe('WebhookWithSecret', function() {
    it('should create an instance of WebhookWithSecret', function() {
      // uncomment below and update the code to test WebhookWithSecret
      //var instane = new TurnitinCoreApi.WebhookWithSecret();
      //expect(instance).to.be.a(TurnitinCoreApi.WebhookWithSecret);
    });

    it('should have the property signingSecret (base name: "signing_secret")', function() {
      // uncomment below and update the code to test the property signingSecret
      //var instance = new TurnitinCoreApi.WebhookWithSecret();
    ...
    it('should have the property allowInsecure (base name: "allow_insecure")', function() {
