...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityCompleteWebhookRequest();
  });
  ...
  describe('SimilarityCompleteWebhookRequest', function() {
    it('should create an instance of SimilarityCompleteWebhookRequest', function() {
      // uncomment below and update the code to test SimilarityCompleteWebhookRequest
      //var instance = new TurnitinCoreApi.SimilarityCompleteWebhookRequest();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityCompleteWebhookRequest);
    });
