...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.Sidebar();
  });
  ...
  describe('Sidebar', function() {
    it('should create an instance of Sidebar', function() {
      ...
      //var instane = new TurnitinCoreApi.Sidebar();
      //expect(instance).to.be.a(TurnitinCoreApi.Sidebar);
    });
    ...
    it('should have the property defaultMode (base name: "default_mode")', function() {
      ...
      //var instance = new TurnitinCoreApi.Sidebar();
