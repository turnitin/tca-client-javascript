...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityMetadataAllOf();
  });
  ...
  describe('SimilarityMetadataAllOf', function() {
    it('should create an instance of SimilarityMetadataAllOf', function() {
      // uncomment below and update the code to test SimilarityMetadataAllOf
      //var instane = new TurnitinCoreApi.SimilarityMetadataAllOf();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityMetadataAllOf);
    });
    ...
    it('should have the property submissionId (base name: "submission_id")', function() {
      ...
      //var instance = new TurnitinCoreApi.SimilarityMetadataAllOf();
