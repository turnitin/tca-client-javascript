...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityOverview();
  });
  ...
  describe('SimilarityOverview', function() {
    it('should create an instance of SimilarityOverview', function() {
      // uncomment below and update the code to test SimilarityOverview
      //var instane = new TurnitinCoreApi.SimilarityOverview();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityOverview);
    });
    ...
    it('should have the property submissionId (base name: "submission_id")', function() {
      ...
      //var instance = new TurnitinCoreApi.SimilarityOverview();
    ...
    it('should have the property matchAggregates (base name: "match_aggregates")', function() {
      // uncomment below and update the code to test the property matchAggregates
      //var instance = new TurnitinCoreApi.SimilarityOverview();
      //expect(instance).to.be();
    });
