...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SubmissionSizeError();
  });
  ...
  describe('SubmissionSizeError', function() {
    it('should create an instance of SubmissionSizeError', function() {
      // uncomment below and update the code to test SubmissionSizeError
      //var instane = new TurnitinCoreApi.SubmissionSizeError();
      //expect(instance).to.be.a(TurnitinCoreApi.SubmissionSizeError);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TurnitinCoreApi.SubmissionSizeError();
