...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.WebhookPathRequest();
  });
  ...
  describe('WebhookPathRequest', function() {
    it('should create an instance of WebhookPathRequest', function() {
      // uncomment below and update the code to test WebhookPathRequest
      //var instane = new TurnitinCoreApi.WebhookPathRequest();
      //expect(instance).to.be.a(TurnitinCoreApi.WebhookPathRequest);
    });

    it('should have the property description (base name: "description")', function() {
      // uncomment below and update the code to test the property description
      //var instance = new TurnitinCoreApi.WebhookPathRequest();
