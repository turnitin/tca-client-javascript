...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.FeaturesViewerModes();
  });
  ...
  describe('FeaturesViewerModes', function() {
    it('should create an instance of FeaturesViewerModes', function() {
      // uncomment below and update the code to test FeaturesViewerModes
      //var instane = new TurnitinCoreApi.FeaturesViewerModes();
      //expect(instance).to.be.a(TurnitinCoreApi.FeaturesViewerModes);
    });
    ...
    it('should have the property matchOverview (base name: "match_overview")', function() {
      ...
      //var instance = new TurnitinCoreApi.FeaturesViewerModes();
