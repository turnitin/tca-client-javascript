...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.WebhookAllOf();
  });
  ...
  describe('WebhookAllOf', function() {
    it('should create an instance of WebhookAllOf', function() {
      ...
      //var instane = new TurnitinCoreApi.WebhookAllOf();
      //expect(instance).to.be.a(TurnitinCoreApi.WebhookAllOf);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.WebhookAllOf();
