...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SuccessMessage();
  });
  ...
  describe('SuccessMessage', function() {
    it('should create an instance of SuccessMessage', function() {
      ...
      //var instane = new TurnitinCoreApi.SuccessMessage();
      //expect(instance).to.be.a(TurnitinCoreApi.SuccessMessage);
    });

    it('should have the property message (base name: "message")', function() {
      // uncomment below and update the code to test the property message
      //var instance = new TurnitinCoreApi.SuccessMessage();
