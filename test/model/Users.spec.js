...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.Users();
  });
  ...
  describe('Users', function() {
    it('should create an instance of Users', function() {
      ...
      //var instane = new TurnitinCoreApi.Users();
      //expect(instance).to.be.a(TurnitinCoreApi.Users);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.Users();
