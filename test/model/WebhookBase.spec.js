...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.WebhookBase();
  });
  ...
  describe('WebhookBase', function() {
    it('should create an instance of WebhookBase', function() {
      // uncomment below and update the code to test WebhookBase
      //var instane = new TurnitinCoreApi.WebhookBase();
      //expect(instance).to.be.a(TurnitinCoreApi.WebhookBase);
    });

    it('should have the property description (base name: "description")', function() {
      // uncomment below and update the code to test the property description
      //var instance = new TurnitinCoreApi.WebhookBase();
