...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instane = new TurnitinCoreApi.InlineResponse200();
      //expect(instance).to.be.a(TurnitinCoreApi.InlineResponse200);
    });

    it('should have the property attachments (base name: "attachments")', function() {
      // uncomment below and update the code to test the property attachments
      //var instance = new TurnitinCoreApi.InlineResponse200();
