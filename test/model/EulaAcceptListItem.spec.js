...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.EulaAcceptListItem();
  });
  ...
  describe('EulaAcceptListItem', function() {
    it('should create an instance of EulaAcceptListItem', function() {
      // uncomment below and update the code to test EulaAcceptListItem
      //var instane = new TurnitinCoreApi.EulaAcceptListItem();
      //expect(instance).to.be.a(TurnitinCoreApi.EulaAcceptListItem);
    });

    it('should have the property userId (base name: "user_id")', function() {
      // uncomment below and update the code to test the property userId
      //var instance = new TurnitinCoreApi.EulaAcceptListItem();
