...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.PdfStatusResponse();
  });
  ...
  describe('PdfStatusResponse', function() {
    it('should create an instance of PdfStatusResponse', function() {
      // uncomment below and update the code to test PdfStatusResponse
      //var instane = new TurnitinCoreApi.PdfStatusResponse();
      //expect(instance).to.be.a(TurnitinCoreApi.PdfStatusResponse);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TurnitinCoreApi.PdfStatusResponse();
