...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimpleSubmissionResponse();
  });
  ...
  describe('SimpleSubmissionResponse', function() {
    it('should create an instance of SimpleSubmissionResponse', function() {
      // uncomment below and update the code to test SimpleSubmissionResponse
      //var instane = new TurnitinCoreApi.SimpleSubmissionResponse();
      //expect(instance).to.be.a(TurnitinCoreApi.SimpleSubmissionResponse);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new TurnitinCoreApi.SimpleSubmissionResponse();
