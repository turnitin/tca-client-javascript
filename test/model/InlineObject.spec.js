...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instane = new TurnitinCoreApi.InlineObject();
      //expect(instance).to.be.a(TurnitinCoreApi.InlineObject);
    });

    it('should have the property status (base name: "status")', function() {
      // uncomment below and update the code to test the property status
      //var instance = new TurnitinCoreApi.InlineObject();
