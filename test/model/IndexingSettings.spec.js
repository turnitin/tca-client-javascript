...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.IndexingSettings();
  });
  ...
  describe('IndexingSettings', function() {
    it('should create an instance of IndexingSettings', function() {
      // uncomment below and update the code to test IndexingSettings
      //var instane = new TurnitinCoreApi.IndexingSettings();
      //expect(instance).to.be.a(TurnitinCoreApi.IndexingSettings);
    });

    it('should have the property addToIndex (base name: "add_to_index")', function() {
      // uncomment below and update the code to test the property addToIndex
      //var instance = new TurnitinCoreApi.IndexingSettings();
