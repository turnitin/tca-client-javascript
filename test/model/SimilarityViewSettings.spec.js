...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SimilarityViewSettings();
  });
  ...
  describe('SimilarityViewSettings', function() {
    it('should create an instance of SimilarityViewSettings', function() {
      // uncomment below and update the code to test SimilarityViewSettings
      //var instane = new TurnitinCoreApi.SimilarityViewSettings();
      //expect(instance).to.be.a(TurnitinCoreApi.SimilarityViewSettings);
    });
    ...
    it('should have the property excludeQuotes (base name: "exclude_quotes")', function() {
      ...
      //var instance = new TurnitinCoreApi.SimilarityViewSettings();
