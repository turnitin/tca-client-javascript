...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.FeaturesSimilarity();
  });
  ...
  describe('FeaturesSimilarity', function() {
    it('should create an instance of FeaturesSimilarity', function() {
      // uncomment below and update the code to test FeaturesSimilarity
      //var instane = new TurnitinCoreApi.FeaturesSimilarity();
      //expect(instance).to.be.a(TurnitinCoreApi.FeaturesSimilarity);
    });

    it('should have the property viewerModes (base name: "viewer_modes")', function() {
      // uncomment below and update the code to test the property viewerModes
      //var instance = new TurnitinCoreApi.FeaturesSimilarity();
