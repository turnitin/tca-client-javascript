...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.FeaturesApi();
  });
  ...
  describe('FeaturesApi', function() {
    describe('featuresEnabledGet', function() {
      it('should call featuresEnabledGet successfully', function(done) {
        //uncomment below and update the code to test featuresEnabledGet
        //instance.featuresEnabledGet(function(error) {
