...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.IndexApi();
  });
  ...
  describe('IndexApi', function() {
    ...
    describe('indexSubmission', function() {
      it('should call indexSubmission successfully', function(done) {
        //uncomment below and update the code to test indexSubmission
        //instance.indexSubmission(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
