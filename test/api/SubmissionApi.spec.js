...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TurnitinCoreApi.SubmissionApi();
  });
  ...
  describe('SubmissionApi', function() {
    ...
    describe('getSubmiddionDetails', function() {
      it('should call getSubmiddionDetails successfully', function(done) {
        //uncomment below and update the code to test getSubmiddionDetails
        //instance.getSubmiddionDetails(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('recoverSubmission', function() {
      it('should call recoverSubmission successfully', function(done) {
        //uncomment below and update the code to test recoverSubmission
        //instance.recoverSubmission(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('uploadSubmittedFile', function() {
      it('should call uploadSubmittedFile successfully', function(done) {
        //uncomment below and update the code to test uploadSubmittedFile
        //instance.uploadSubmittedFile(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
